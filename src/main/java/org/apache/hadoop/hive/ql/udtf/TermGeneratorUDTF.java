...
@Description(
		...
		extended = "Example:\n" +
		"  > SELECT termgenerator(id) as (seq, term) FROM pattern_table a limit 1000;\n" +
		"  010, 10\n" + 
		"  010, 00\n" +
		"  010, 01\n"
		)
public class TermGeneratorUDTF extends GenericUDTF {
	...
	private PrimitiveObjectInspector stringOI = null;
	  ...
	  public ArrayList<Object[]> processInputRecord(String pattern){
		    ...
		    for(int i = 0; i < pattern.length(); i++){
		    	...
		    	result.add(new Object[] {i+1, sb.deleteCharAt(i).toString()});
		    }
		    return result;
	  }
